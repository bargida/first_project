...
<head>
    ...
    <link href="assets/https://fonts.googleapis.com/css2?family=Handlee&family=Nunito&display=swap" rel="stylesheet">
    ...
    <div class="container-fluid bg-secondary text-white mt-5 py-5 px-sm-3 px-md-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <form action="/users" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" name="name" class="form-control border-0 py-4" placeholder="Ismingiz" required="required" />
                    </div>
                    <div class="form-group">
                        <input type="text" name="messages" class="form-control border-0 py-4" placeholder="Shikoyatni yozing"
                            required="required" />
                    </div>
                    <div>
        ...
        <div class="container-fluid pt-5" style="border-top: 1px solid rgba(23, 162, 184, .2);;">
            <p class="m-0 text-center text-white">
                &copy; <a class="text-primary font-weight-bold" href="assets/index.html">Jajji Professor</a>. Barcha huquqlar himoyalangan.
                <a class="text-primary font-weight-bold" href="assets/https://htmlcodex.com">IT RISE UP</a>
            </p>
        </div>
    </div>
    <!-- Footer End -->
